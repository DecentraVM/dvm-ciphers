...
class BaseRunner(ABC):
    ...
    def _run_directly(
        ...
        """Runs the code without dependencies"""
        pass
    ...
    def _run_with_dependencies(
        ...
        """Runs the code with installed dependencies"""
        pass

    @abstractmethod
    def _process_output(self, stdout: str) -> tuple[str, Dict[str, Any]]:
        """Processes stdout to extract both regular output and the result object"""
        pass
    ...
    def run(
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(
                ...
                prepared_code = self._prepare_code(
                    code,
                    inputs or {},
                    env_vars or {}
                )
            ...
            if not dependencies:
                logger.info("No dependencies detected. Running code directly.")
                ...
                logger.info(
                    f"Dependencies found: {dependencies}. Using a virtual environment."
                )
                result = self._run_with_dependencies(
                    code_file_path,
                    dependencies,
                    inputs or {},
                    env_vars or {},
            ...
            return {
                "error": f"Execution timed out. Max {execution_timeout} seconds"
            }
